...
class FieryLexiconSFW:
    ...
    INTRO_MESSAGES = [
        ...
        "⚔️ **The Game Master has signaled the start. May the funniest fighter win (or at least provide good entertainment).**",
        ...
        "⚔️ **The suite is sealed. Only one will walk out with their pride fully intact.**",
        "⚔️ **The smell of energetic sweat and popcorn permeates. The Master watches from the shadows, giggling.**",
        ...
        "⚔️ **Submit your ego, for it will be hilariously shattered before the night is over.**",
        "⚔️ **Each of you is a gorgeous, clumsy fighter waiting to be cheered for and discarded.**",
        ...
        "⚔️ **Expose your most vulnerable spots. The spectators are watching with heavy anticipation.**",
        ...
        "⚔️ **The Arena is a playground for your clumsiest, wildest urges.**",
    ...
    OPENERS = [
        ...
        "**{winner}** forced a heavy, polished metal bit between **{loser}**'s teeth so they’d stop giggling,",
    ...
    ACTIONS = [
        "and delivered a teasing blow to the shoulder that made them giggle as they", 
        "and ruthlessly pushed their limits until they begged for a timeout,",
        "and made them beg for a break through the gag before they broke,", 
        "and administered a devastatingly thorough tickling punishment that melted them,",
        "and stripped away their resistance, leaving them a tired, yielding puddle,", 
        "and exerted absolute, good-natured authority until **{loser}** completely short-circuited,",
        ...
        "and silenced their pleas with a playful kiss that completely melted them,",
        "and used them as a mere tool of fun until they gave up and enjoyed it,", 
        "and exerted a crushing weight, grinding heavily until they",
        ...
        "and extracted a final, high-pitched giggle of total surrender before",
        "and corrected **{loser}**'s posture with a slap to the rear that echoed loudly,",
        "and humiliated **{loser}** by making them wear funny ears in front of the audience until they broke,",
        ...
        "and applied freezing ice to their most sensitive parts until **{loser}** arched uncontrollably,",
        "and forced them to swallow their own laughter as the pleasure-pain spiked until",
        ...
        "and forced a state of edge-torture that left **{loser}** weeping and laughing until",
        "and used a multi-tailed slapper to turn **{loser}**'s flesh crimson and hot until",
        "and applied sensory-overload goggles playing incredibly silly videos until",
        "and utilized a weighted piercing to ensure **{loser}** felt every single jiggle until",
        "and utilized a violet wand to send sparks of raw energy through their body until",
        "and applied a high-frequency vibration to their skin that reduced them to a sobbing mess until",
        "and utilized a heavy paddle to leave the Master's handprint in bright red until",
        "and enforced a deep state of hypnosis that made them think they were a clumsy puppy until",
        ...
        "and utilized a rhythmic, heavy session that left them totally dizzy until",
        "and enforced a public interrogation about their silliest fantasies until",
        "and utilized a heavy leather mask to muffle their embarrassing squeals of joy until",
        "and applied a row of clips that made every movement an arousing ordeal until",
        "and shoved them into a cage designed for a much smaller, extremely flexible person until",
        "and used a heavy, leather harness to bind them into a helpless, funny knot until",
        "and stripped away their ability to see, making every touch a jump-scare of surprise until",
        "and applied a painful, hot wax drip that permanently addicted them to the sensation until"
    ]

    FINISHERS = [
        "collapsed into eternal, silent submission.", 
        "ceased to struggle and just enjoyed the incredibly fun ride.",
        "faded into the shadows of the Arena, happy and exhausted.", 
        "became nothing more than a used, very ticklish plaything on the floor.",
        "succumbed completely to the Master's every silly whim.", 
        "broke apart like a fragile, over-stimulated toy.",
        "surrendered their very last brain cell to the sheer sensation.", 
        "was extinguished in a massive flash of heat and blinding energy.",
        "stopped breathing under the weight of the massive excitement.", 
        "accepted the final, dark, and incredibly fun release.",
        ...
        "lost all identity in the moment of their final, screaming excitement.",
        ...
        "was reduced to a quivering heap of spent nerves and soft leather.",
        ...
        "accepted the heavy crown of 'Biggest Clown' as their final prize.",
        "dissolved into a mess of tears, sweat, and completely broken worship.",
        "was locked into a display box to be used at the winner's convenience.",
        "turned into a literal footstool in the winner's private lounge.",
    ...
    FINAL_KILL_MESSAGES = [
        ...
        "👑 **TOTAL DOMINATION:** **{winner}** edged **{loser}** completely, standing alone as the Absolute Authority of Fun!",
        "👑 **THE END:** **{winner}** tightened the final chain on **{loser}**, savoring the victory of the Eternal Possession!",
        "👑 **FINAL AUTHORITY:** **{winner}** silenced the last rival **{loser}** with a kiss, ascending as the Sovereign!",
        "👑 **CROWNED IN SHAME:** **{winner}** stands over the heavily breathing body of **{loser}**, the only one left standing!",
        "👑 **THE MASTER'S CHOSEN:** **{winner}** squeezed the thighs of **{loser}**, proving who truly owns the arena's floor!",
        "👑 **BEYOND REPAIR:** **{winner}** dismantled **{loser}** in front of the Master, securing total victory!",
        "👑 **ULTIMATE PROTOCOL:** **{winner}** locked the final cage on **{loser}**, welding their legacy into the dungeon!",
        "👑 **THE LAST WORD:** **{winner}** made **{loser}** whisper their name in admiration before the final lights went out!",
        "👑 **SOVEREIGN CLIMAX:** **{winner}** stands upon the wreckage of **{loser}**'s pride, the Absolute King of the Arena!",
        "👑 **THE SEALED FATE:** **{winner}** kissed their mark into **{loser}**, ending the game with a display of pure ownership!"
    ]

    WINNER_PINGS = [
        "📢 Attention please: Fighter {mention} has successfully broken every rival and won this Hangrygames SFW Edition! Kneel before your new Authority.",
        "📢 The Arena has spoken! {mention} has claimed total dominion over the floor. Fighters, acknowledge your superior.",
        "📢 A new Master of the pit arises! {mention} stands alone, covered in the glory of their rivals. Glory to the victor.",
        "📢 The chains have settled. {mention} is the last one standing in this Hangrygames SFW Edition! Absolute possession achieved.",
        "📢 Final report: Fighters discarded. Rivals broken. {mention} has been declared the Supreme Asset of the dungeon!"
    ]

    LEGENDARY_EVENTS = [
        "⛓️ **THE GREAT RESTRAINT:** A massive web of silk dropped! **{losers}** were caught and trapped in a permanent state of breathless bliss!",
        "💦 **THE SERUM LEAK:** A funny gas flooded! **{losers}** lost all sense of self and surrendered to the arena's hunger!",
        "🔞 **THE MASTER'S WHIM:** The lights flickered. With a snap, **{losers}** were discarded as unworthy playthings!",
        "🫦 **THE OVERWHELMING SENSATION:** An overload frequency blasted the speakers. **{losers}** collapsed in a heap of shattered nerves!",
        ...
        "💦 **THE FLOOD OF LUST:** The arena was submerged in oil. **{losers}** couldn't find their footing and were suffocated by pleasure!",
        "⛓️ **THE PREDATOR'S WEB:** The floor turned into a giant magnet! **{losers}** were slammed together into a singular mass!",
        "🧪 **THE OBLIVION DRIP:** A rain of numbing liquid fell! **{losers}** lost all feeling and were dragged into the dark!",
        "🔞 **THE CAGE COLLAPSE:** The ceiling lowered! **{losers}** were flattened, their marks becoming part of the arena!"
    ]
