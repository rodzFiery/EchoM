...
class FieryShip(commands.Cog):
    def __init__(self, bot):
        ...
        self.triad_lexicon = {
            "low": [
                "Crowded and cold. {u1}, {u2}, and {u3} are a mess of mismatched chains.",
                ...
                "Minimal collective friction. The Master yawns at this uninspired triad.",
                "A triangle of indifference. Someone is clearly a third wheel in this cell.",
                "The frequency shatters. {u1} cannot maintain the link between {u2} and {u3}.",
                "Functional but hollow. Three bodies in a dark room with nothing to say.",
